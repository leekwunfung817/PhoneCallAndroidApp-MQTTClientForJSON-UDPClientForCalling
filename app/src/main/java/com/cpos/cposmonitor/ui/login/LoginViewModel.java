...
import com.cpos.cposmonitor.data.LoginRepository;
import com.cpos.cposmonitor.data.Result;
...
public class LoginViewModel extends ViewModel {
    ...
    public void login(String username, String password, String device_id) {
        ...
        Result<LoggedInUser> result = loginRepository.login(username, password, device_id);
